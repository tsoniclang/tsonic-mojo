...
export interface MojoCallableExpressionSelection {
  ...
  readonly typeParameters: readonly import("../program/model.js").MojoAnalyzedTypeParameter[];
  ...
  readonly owner?: import("../program/model.js").MojoAnalyzedClassOwner;
...
export type MojoObjectLiteralContribution =
  | {
      ...
      readonly element: Node;
      readonly value: Node;
      readonly field: MojoAnalyzedInterfaceField | import("../program/model.js").MojoAnalyzedAccessorProperty;
...
export type MojoObjectLiteralSelection =
  | {
      ...
      readonly construction: import("../declarations/construction-model.js").MojoProjectConstruction;
      readonly resultType: MojoTargetTypeRef;
  ...
  | {
      ...
      readonly definition: import("./structural-objects.js").MojoStructuralObjectDefinition;
      readonly fields: readonly {
        readonly element: Node;
        readonly value: Node;
        readonly storageIndex: number;
        readonly field: import("./structural-objects.js").MojoStructuralObjectField;
      }[];
    };

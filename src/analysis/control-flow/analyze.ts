...
import { inferMojoExpressionType, isMojoExpressionNode } from "../expressions/types.js";
import type {
  MojoAnalyzedClass,
...
import { mergeMojoErrorTypes } from "../resources/effects.js";
import {
  expectedExpressionType,
  selectedSourceCallArgumentExpectedType,
} from "../expected-types/expressions.js";
import {
...
import { analyzeCall, analyzeElement, analyzeProperty } from "./operations.js";
...
export interface MojoExecutableRegionAnalysisInput {
  ...
  readonly callableByDeclaration: WeakMap<Node, import("../program/model.js").MojoAnalyzedProjectCallable>;
  ...
  readonly interfaceByTypeId: ReadonlyMap<string, import("../program/model.js").MojoAnalyzedInterface>;
